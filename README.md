...
Choose one or more sections under **Choose sections**, then **Start section exam**. Answer every question and select **Submit all answers**. Feedback and source pages appear only afterward. While taking an exam, the page header and dashboard are hidden; Next, Previous, question navigation, and Resume bring the question back into view.
